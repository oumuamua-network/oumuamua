...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("oumuamua"),
	impl_name: create_runtime_str!("oumuamua"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		CollateralModule: collateral::{Module, Call, Storage, Event<T>},
		// ExampleModule: substrate_module_oumuamua::{Module, Call, Storage, Event<T>},
